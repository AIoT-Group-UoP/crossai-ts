...
class LE(BaseEstimator, TransformerMixin):
    ...
    def transform(self, X: CoreDataset) -> CoreDataset:
        ...
        return CoreDataset(X.X, encoded_labels, X._id)
    ...
    def inverse_transform(self, dataset):
        ...
        return CoreDataset(dataset.X, original_labels, dataset._id)
